...
/// <summary>
///     Tests for AL0081: Missing Health Checks.
/// </summary>
public sealed partial class Al0081MissingHealthChecksTests {
    ...
    private static Task VerifyAsync(string source) {
        var test = new CSharpAnalyzerTest<Al0081MissingHealthChecksAnalyzer, DefaultVerifier> {
    ...
    public Task ShouldReportWhenHostCreateDefaultBuilderWithoutHealthChecks() =>
        VerifyAsync(
            ...
            public class Program {
                public static void Main() {
                    var host = {|AL0081:Host.CreateDefaultBuilder()|};
                }
            }
            """);
