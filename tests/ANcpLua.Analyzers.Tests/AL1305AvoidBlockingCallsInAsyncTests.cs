using AnalyzerTestBase = ANcpLua.Roslyn.Utilities.Testing.AnalyzerTest<ANcpLua.Analyzers.Analyzers.Al1305AvoidBlockingCallsInAsyncAnalyzer>;

namespace ANcpLua.Analyzers.Tests;

/// <summary>
///     Tests for AL1305: Avoid blocking calls in async methods.
/// </summary>
public sealed partial class Al1305AvoidBlockingCallsInAsyncTests : AnalyzerTestBase {
    [Fact]
