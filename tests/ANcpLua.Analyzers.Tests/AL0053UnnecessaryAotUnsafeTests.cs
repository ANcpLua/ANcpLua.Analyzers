...
/// <summary>
///     Tests for AL0053: Unnecessary [AotUnsafe] attribute.
/// </summary>
public sealed partial class Al0053UnnecessaryAotUnsafeTests : AnalyzerTest<Al0053UnnecessaryAotUnsafeAnalyzer> {
    ...
    public Task ShouldReportWhenAotUnsafeMethodHasNoUnsafePatterns() =>
        VerifyAsync($$"""
                      ...
                      public class C {
                          [{|AL0053:ANcpLua.AotTesting.AotUnsafe("Not needed")|}]
