...
/// <summary>
///     Tests for AL0045: Use Guard.NotNullOrEmpty instead of if (string.IsNullOrEmpty) throw.
/// </summary>
public sealed partial class Al0045UseGuardNotNullOrEmptyTests : AnalyzerTest<Al0045UseGuardNotNullOrEmptyAnalyzer> {
    [Fact]
