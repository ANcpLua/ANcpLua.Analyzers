...
/// <summary>
///     Code fix tests for AL1220: BCL throw helpers → Guard.* helpers from ANcpLua.Roslyn.Utilities.
/// </summary>
public sealed partial class Al1220UseGuardForThrowIfCodeFixTests
    : CodeFixTest<Al1220UseGuardForThrowIfAnalyzer, Al1220UseGuardForThrowIfCodeFixProvider> {
    /// <summary>
