...
/// <summary>
///     Tests for AL1504: [DuckDbTable] type must be partial.
/// </summary>
public sealed partial class Al1504DuckDbTableMustBePartialTests : AnalyzerTest<Al1504DuckDbTableMustBePartialAnalyzer> {
...
/// <summary>
///     Code fix tests for AL1504: Adds partial modifier to [DuckDbTable] types.
/// </summary>
public sealed partial class Al1504CodeFixTests : CodeFixTest<Al1504DuckDbTableMustBePartialAnalyzer, Al1504DuckDbTableCodeFixProvider> {
    private const string DuckDbStubs = """
                                       namespace Qyl.Collector.Storage {
                                           [System.AttributeUsage(System.AttributeTargets.Class | System.AttributeTargets.Struct)]
                                           public class DuckDbTableAttribute : System.Attribute {
