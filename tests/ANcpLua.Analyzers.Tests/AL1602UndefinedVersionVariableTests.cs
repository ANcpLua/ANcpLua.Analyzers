...
using AnalyzerTestBase = ANcpLua.Roslyn.Utilities.Testing.AnalyzerTest<ANcpLua.Analyzers.Analyzers.Al1602UndefinedVersionVariableAnalyzer>;

namespace ANcpLua.Analyzers.Tests;

/// <summary>
///     Tests for AL1602: Undefined version variable.
///     Warns when $(VariableName) is used in Directory.Packages.props but not defined in Version.props.
/// </summary>
public sealed partial class Al1602UndefinedVersionVariableTests : AnalyzerTestBase {
    ...
    public Task ShouldReportWhenVariableNotDefined() {
        ...
        var expected = new DiagnosticResult("AL1602", DiagnosticSeverity.Warning)
    ...
    public Task ShouldNotReportForHardcodedVersions() {
        ...
        // AL1600 handles hardcoded versions, not AL1602
        // Explicit empty diagnostics array to resolve overload ambiguity
        return VerifyAsync(
            EmptyCode,
            [("Version.props", VersionProps), ("Directory.Packages.props", DirectoryPackagesProps)],
    ...
    public Task ShouldReportMultipleUndefinedVariables() {
        ...
        var expected1 = new DiagnosticResult("AL1602", DiagnosticSeverity.Warning)
            .WithLocation("Directory.Packages.props", 3, 44)
            .WithArguments("Package1", "Undefined1");

        var expected2 = new DiagnosticResult("AL1602", DiagnosticSeverity.Warning)
