using AnalyzerTestBase = ANcpLua.Roslyn.Utilities.Testing.AnalyzerTest<ANcpLua.Analyzers.Analyzers.Al0112FireAndForgetTaskAnalyzer>;

namespace ANcpLua.Analyzers.Tests;

/// <summary>
///     Tests for AL0112: Avoid fire-and-forget task discard.
/// </summary>
public sealed partial class Al0112FireAndForgetTaskTests : AnalyzerTestBase {
    [Fact]
