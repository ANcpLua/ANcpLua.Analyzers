...
/// <summary>
///     Tests for AL1401: [AotTest]/[TrimTest] methods should return 100 to indicate success.
/// </summary>
public sealed partial class Al1401AotTestExitCode100Tests : AnalyzerTest<Al1401AotTestExitCode100Analyzer> {
    ...
    public Task ShouldReportExpressionBodyNotReturning100() =>
        VerifyAsync($$"""
                      ...
                      public class C {
                          [ANcpLua.AotTesting.AotTest]
                          public int TestMethod() => {|AL1401:0|};
                      }
                      """);
