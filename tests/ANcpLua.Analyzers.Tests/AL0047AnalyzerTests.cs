...
/// <summary>
///     Tests for AL0047: Use Guard.NotZero instead of if (x == 0) throw ArgumentOutOfRangeException.
/// </summary>
public sealed partial class Al0047AnalyzerTests : AnalyzerTest<Al0047UseGuardNotZeroAnalyzer> {
    [Fact]
