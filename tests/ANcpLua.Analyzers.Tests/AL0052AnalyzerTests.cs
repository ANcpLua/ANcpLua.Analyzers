...
/// <summary>
///     Tests for AL0052: [AotSafe] code must not call [AotUnsafe] code.
/// </summary>
public sealed partial class Al0052AnalyzerTests : AnalyzerTest<Al0052AotSafeCallsAotUnsafeAnalyzer> {
    ...
    public Task ShouldReportWhenAotSafeCallsAotUnsafeOnDifferentClass() =>
        VerifyAsync($$"""
                      ...
                      public class C {
                          [ANcpLua.AotTesting.AotSafe]
                          public void SafeMethod() {
                              {|AL0052:UnsafeHelper.UnsafeMethod()|};
                          }
                      }
    ...
    public Task ShouldReportMultipleViolationsInSameMethod() =>
        VerifyAsync($$"""
                      ...
                      public class C {
                          [ANcpLua.AotTesting.AotSafe]
                          public void SafeMethod() {
                              {|AL0052:UnsafeMethod1()|};
                              {|AL0052:UnsafeMethod2()|};
                          }
