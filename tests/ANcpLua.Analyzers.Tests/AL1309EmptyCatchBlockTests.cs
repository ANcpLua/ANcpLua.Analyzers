using AnalyzerTestBase = ANcpLua.Roslyn.Utilities.Testing.AnalyzerTest<ANcpLua.Analyzers.Analyzers.Al1309EmptyCatchBlockAnalyzer>;

namespace ANcpLua.Analyzers.Tests;

/// <summary>
///     Tests for AL1309: Empty catch block swallows exceptions.
/// </summary>
public sealed partial class Al1309EmptyCatchBlockTests : AnalyzerTestBase {
    [Fact]
