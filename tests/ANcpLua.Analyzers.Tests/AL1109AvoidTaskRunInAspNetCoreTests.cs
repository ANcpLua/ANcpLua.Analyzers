using AnalyzerTestBase = ANcpLua.Roslyn.Utilities.Testing.AnalyzerTest<ANcpLua.Analyzers.Analyzers.Al1109AvoidTaskRunInAspNetCoreAnalyzer>;

namespace ANcpLua.Analyzers.Tests;

/// <summary>
///     Tests for AL1109: Avoid Task.Run in ASP.NET Core request handlers.
/// </summary>
public sealed partial class Al1109AvoidTaskRunInAspNetCoreTests : AnalyzerTestBase {
