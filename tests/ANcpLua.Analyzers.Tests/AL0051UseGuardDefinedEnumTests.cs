...
/// <summary>
///     Tests for AL0051: Use Guard.DefinedEnum instead of if (!Enum.IsDefined) throw patterns.
/// </summary>
public sealed partial class Al0051UseGuardDefinedEnumTests : AnalyzerTest<Al0051UseGuardDefinedEnumAnalyzer> {
    [Fact]
