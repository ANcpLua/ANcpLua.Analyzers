...
/// <summary>
///     Tests for AL0121: Avoid NormalizeWhitespace in source generators.
/// </summary>
public sealed partial class Al0121NormalizeWhitespaceTests : AnalyzerTest<Al0121NormalizeWhitespaceAnalyzer> {
...
/// <summary>
///     Code fix tests for AL0121: Removes NormalizeWhitespace() call.
/// </summary>
public sealed partial class Al0121CodeFixTests : CodeFixTest<Al0121NormalizeWhitespaceAnalyzer, Al0121NormalizeWhitespaceCodeFixProvider> {
    private const string SyntaxStubs = """
                                       namespace Microsoft.CodeAnalysis {
                                           public abstract class SyntaxNode {
                                               public SyntaxNode NormalizeWhitespace() => this;
