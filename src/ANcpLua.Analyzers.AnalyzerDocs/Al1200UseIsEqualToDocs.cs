...
/// <summary>
///     Docs scenarios for AL1200: Use IsEqualTo extension instead of SymbolEqualityComparer.Equals.
...
/// </summary>
public sealed partial class Al1200UseIsEqualToDocs
{
    ...
    public Task SymbolEqualityComparerDefaultEquals_Failure() =>
        AnalyzerDocsUtils.RunAndCaptureDiagnosticAsync<Al1200UseIsEqualToAnalyzer>($$"""
            {{Polyfill}}
            public class C {
