...
/// <summary>
///     Code fix for AL1218: Converts if (!Enum.IsDefined) throw to Guard.DefinedEnum().
/// </summary>
/// <remarks>
///     <list type="bullet">
...
///     </list>
/// </remarks>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Al1218UseGuardDefinedEnumCodeFixProvider))]
[Shared]
