...
/// <summary>
///     Code fix for AL0039: Converts StringComparison method calls to extension methods.
/// </summary>
/// <remarks>
///     <list type="bullet">
...
///     </list>
/// </remarks>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Al0039UseStringComparisonExtensionsCodeFixProvider))]
[Shared]
public sealed partial class Al0039UseStringComparisonExtensionsCodeFixProvider
    ...
    protected override CodeAction CreateCodeAction(
        ...
        CodeAction.Create(
            CodeFixResources.AL0039CodeFixTitle,
            _ => ConvertToExtensionMethod(document, invocation, root),
            nameof(Al0039UseStringComparisonExtensionsCodeFixProvider));
