...
/// <summary>
///     Code fix provider for AL1007 - makes GetSchema return null with expression body.
/// </summary>
...
public sealed partial class Al1007IXmlSerializableCodeFixProvider : CodeFixProvider {
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context) {
        ...
        foreach (var diagnostic in context.Diagnostics) {
            if (diagnostic.Id != Al1006ToAl1008IXmlSerializableAnalyzer.DiagnosticIdAl1007) {
                continue;
            }
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    CodeFixResources.AL1007CodeFixTitle,
                    _ => FixAsync(context.Document, target, root),
                    nameof(CodeFixResources.AL1007CodeFixTitle)),
                diagnostic);
        }
    }
