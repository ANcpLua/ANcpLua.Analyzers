...
/// <summary>
///     Code fix provider for AL0122 - adds partial modifier to [DuckDbTable] types.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Al0122DuckDbTableCodeFixProvider))]
[Shared]
public sealed partial class Al0122DuckDbTableCodeFixProvider : CodeFixProvider {
    public override ImmutableArray<string> FixableDiagnosticIds =>
        [Al0122DuckDbTableMustBePartialAnalyzer.DiagnosticId];
