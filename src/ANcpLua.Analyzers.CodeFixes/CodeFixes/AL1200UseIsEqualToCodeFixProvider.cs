...
/// <summary>
///     Code fix for AL1200: Converts SymbolEqualityComparer.Equals to IsEqualTo extension.
/// </summary>
/// <remarks>
///     <c>SymbolEqualityComparer.Default.Equals(a, b)</c> → <c>a.IsEqualTo(b)</c>
/// </remarks>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Al1200UseIsEqualToCodeFixProvider))]
[Shared]
public sealed partial class Al1200UseIsEqualToCodeFixProvider : AlCodeFixProvider<InvocationExpressionSyntax> {
    public override ImmutableArray<string> FixableDiagnosticIds => [Al1200UseIsEqualToAnalyzer.DiagnosticId];
