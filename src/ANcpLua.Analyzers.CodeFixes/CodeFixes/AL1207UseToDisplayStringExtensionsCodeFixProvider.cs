...
/// <summary>
///     Code fix for AL1207: Converts ToDisplayString with format to extension methods.
/// </summary>
/// <remarks>
///     <list type="bullet">
///         <item>
...
///     </list>
/// </remarks>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Al1207UseToDisplayStringExtensionsCodeFixProvider))]
[Shared]
public sealed partial class Al1207UseToDisplayStringExtensionsCodeFixProvider
    ...
    public override ImmutableArray<string> FixableDiagnosticIds => [Al1207UseToDisplayStringExtensionsAnalyzer.DiagnosticId];
