...
/// <summary>
///     Vendored snapshot of official OpenTelemetry semantic convention attribute keys from
///     <c>semantic-conventions/model/**/*.yaml</c>.
/// </summary>
/// <remarks>
///     <para>
///         This catalog is intentionally limited to attribute-key recognition. It includes
///         current and deprecated official attribute IDs from the model snapshot so that
///         analyzers can distinguish "official but deprecated" from completely ad-hoc keys.
///     </para>
///     <para>
///         This type is not schema-aware and should not be used to decide whether a key is
///         current, preferred, or valid for a specific signal/model context. Deprecated and
///         context-sensitive migrations are handled by dedicated analyzers.
///     </para>
/// </remarks>
internal static class OpenTelemetryOfficialSemconvCatalog {
    private static readonly HashSet<string> OfficialAttributeKeys = new(
        OfficialAttributeKeysData.Split(['\n'], StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries),
        StringComparer.Ordinal);

    private static readonly string[] OfficialAttributeKeyPrefixes = [
    ...
    internal static bool IsOfficialAttributeKey(string attributeName) =>
        OfficialAttributeKeys.Contains(attributeName) || HasOfficialAttributeKeyPrefix(attributeName);

    private static bool HasOfficialAttributeKeyPrefix(string attributeName) {
        foreach (var prefix in OfficialAttributeKeyPrefixes) {
    ...
    private const string OfficialAttributeKeysData = """
android.app.state
