...
/// <summary>
///     AL1800: Detects Loom tools with destructive side effects that do not require approval.
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1800DestructiveToolMustRequireApprovalAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1800.</summary>
    private const string DiagnosticId = "AL1800";
