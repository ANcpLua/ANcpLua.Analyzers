...
/// <summary>
///     AL1200: Suggests using IsEqualTo extension instead of SymbolEqualityComparer.Equals.
/// </summary>
/// <remarks>
///     <c>SymbolEqualityComparer.Default.Equals(a, b)</c> → <c>a.IsEqualTo(b)</c>
/// </remarks>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public sealed partial class Al1200UseIsEqualToAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1200.</summary>
    public const string DiagnosticId = "AL1200";
