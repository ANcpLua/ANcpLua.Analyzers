...
/// <summary>
///     AL1600: Detects hardcoded package versions in Directory.Packages.props files.
///     Package versions should use $(VariableName) from Version.props for centralized management.
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public sealed partial class Al1600HardcodedPackageVersionAnalyzer : DiagnosticAnalyzer {
    /// <summary>AL1600: Hardcoded package version in Directory.Packages.props.</summary>
    private const string DiagnosticId = "AL1600";
    ...
    private static readonly LocalizableResourceString s_title = new(
        nameof(Resources.AL1600AnalyzerTitle), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_messageFormat = new(
        nameof(Resources.AL1600AnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_description = new(
        nameof(Resources.AL1600AnalyzerDescription), Resources.ResourceManager, typeof(Resources));
