...
/// <summary>
///     AL1601: Detects when Version.props is not imported in Directory.Build.props or Directory.Packages.props.
...
public sealed partial class Al1601VersionPropsNotImportedAnalyzer : DiagnosticAnalyzer {
    /// <summary>AL1601: Version.props not imported.</summary>
    private const string DiagnosticId = "AL1601";
    ...
    private static readonly LocalizableResourceString s_title = new(
        nameof(Resources.AL1601AnalyzerTitle), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_messageFormat = new(
        nameof(Resources.AL1601AnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_description = new(
        nameof(Resources.AL1601AnalyzerDescription), Resources.ResourceManager, typeof(Resources));
