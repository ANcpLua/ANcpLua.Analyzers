...
/// <summary>
///     AL1801: Detects Loom tools that do not declare their side effect.
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1801ToolMustDeclareSideEffectAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1801.</summary>
    private const string DiagnosticId = "AL1801";
