...
/// <summary>
///     AL1208: Suggests using Guard.NotNull() instead of null-coalescing throw patterns.
/// </summary>
/// <remarks>
///     <list type="bullet">
...
public sealed partial class Al1208UseGuardNotNullAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1208.</summary>
    public const string DiagnosticId = "AL1208";
    ...
    private static void AnalyzeCoalesce(OperationAnalysisContext context) {
        ...
        context.ReportDiagnostic(Diagnostic.Create(s_rule, coalesce.Syntax.GetLocation(), coalesce.Value.GetOperandName()));
    }
