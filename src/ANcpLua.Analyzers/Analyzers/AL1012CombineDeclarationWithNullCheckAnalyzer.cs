...
public sealed partial class Al1012CombineDeclarationWithNullCheckAnalyzer : AlAnalyzer {
    /// <summary>AL1012: Combine declaration with subsequent null-check.</summary>
    public const string DiagnosticId = "AL1012";
