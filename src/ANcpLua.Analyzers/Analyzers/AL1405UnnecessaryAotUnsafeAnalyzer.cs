...
/// <summary>
///     AL1405: [AotUnsafe] attribute applied to code that doesn't use AOT-incompatible patterns.
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1405UnnecessaryAotUnsafeAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1405.</summary>
    private const string DiagnosticId = "AL1405";
