...
/// <summary>
///     AL1207: Suggests using GetFullyQualifiedName()/GetMetadataName() instead of ToDisplayString with format.
/// </summary>
/// <remarks>
///     <list type="bullet">
///         <item>
...
public sealed partial class Al1207UseToDisplayStringExtensionsAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1207.</summary>
    public const string DiagnosticId = "AL1207";
