...
/// <summary>Describes the named argument AL0126 should add.</summary>
public readonly partial record struct Al0126Suggestion(
...
/// </summary>
public static partial class Al0126CancellationTokenPropagationAnalysis {
    ...
    /// <summary>Tries to find a safe AL0126 suggestion for the specified invocation.</summary>
    public static bool TryFindSuggestion(
        IInvocationOperation invocation,
        INamedTypeSymbol cancellationTokenType,
        INamedTypeSymbol? expressionType,
        CancellationToken cancellationToken,
        out Al0126Suggestion suggestion) {
        suggestion = default;
