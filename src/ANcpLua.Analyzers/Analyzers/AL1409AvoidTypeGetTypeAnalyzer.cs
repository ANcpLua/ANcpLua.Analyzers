...
/// <summary>
///     AL1409: Avoid Type.GetType with dynamic name in AOT context.
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1409AvoidTypeGetTypeAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1409.</summary>
    private const string DiagnosticId = "AL1409";
