...
/// <summary>
///     AL1218: Suggests using Guard.DefinedEnum() instead of if (!Enum.IsDefined) throw patterns.
/// </summary>
/// <remarks>
///     <list type="bullet">
...
public sealed partial class Al1218UseGuardDefinedEnumAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1218.</summary>
    public const string DiagnosticId = "AL1218";
