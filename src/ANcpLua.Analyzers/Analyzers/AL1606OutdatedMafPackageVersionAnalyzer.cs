...
/// <summary>
///     AL1606: Detects outdated Microsoft Agent Framework (MAF) and related package versions
...
public sealed partial class Al1606OutdatedMafPackageVersionAnalyzer : DiagnosticAnalyzer {
    /// <summary>AL1606: Outdated MAF ecosystem package version.</summary>
    private const string DiagnosticId = "AL1606";
    ...
    private static readonly LocalizableResourceString s_title = new(
        nameof(Resources.AL1606AnalyzerTitle), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_messageFormat = new(
        nameof(Resources.AL1606AnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_description = new(
        nameof(Resources.AL1606AnalyzerDescription), Resources.ResourceManager, typeof(Resources));
