...
/// <summary>
///     AL1201: Suggests using HasAttribute extension instead of GetAttributes() patterns.
/// </summary>
/// <remarks>
///     <list type="bullet">
...
public sealed partial class Al1201UseHasAttributeAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1201.</summary>
    public const string DiagnosticId = "AL1201";
    ...
    ///     When true, the foreach pattern is valid and shouldn't trigger AL1201.
    /// </summary>
