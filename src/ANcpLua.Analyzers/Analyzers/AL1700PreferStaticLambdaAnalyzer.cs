...
public sealed partial class Al1700PreferStaticLambdaAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1700.</summary>
    public const string DiagnosticId = "AL1700";
