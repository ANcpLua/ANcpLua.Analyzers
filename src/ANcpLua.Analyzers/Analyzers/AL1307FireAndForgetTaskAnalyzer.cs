...
/// <summary>
///     AL1307: Detects fire-and-forget task discards (<c>_ = SomeAsyncMethod()</c>).
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1307FireAndForgetTaskAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1307.</summary>
    private const string DiagnosticId = "AL1307";
