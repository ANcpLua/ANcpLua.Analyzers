...
/// <summary>
///     AL1703: Use <c>var</c> when the initializer makes the type apparent.
/// </summary>
/// <remarks>
...
public sealed partial class Al1703UseImplicitTypeWhenApparentAnalyzer : AlAnalyzer {
    /// <summary>AL1703: Use implicit type when the type is apparent.</summary>
    public const string DiagnosticId = "AL1703";
    ...
    /// <summary>Gets the diagnostic descriptor for AL1703.</summary>
