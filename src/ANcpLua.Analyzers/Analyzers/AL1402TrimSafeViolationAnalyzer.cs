...
/// <summary>
///     AL1402: Code marked [TrimSafe] must not call methods with [RequiresUnreferencedCode].
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1402TrimSafeViolationAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1402.</summary>
    private const string DiagnosticId = "AL1402";
