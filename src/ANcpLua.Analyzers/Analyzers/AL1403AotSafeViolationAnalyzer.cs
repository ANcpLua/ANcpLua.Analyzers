...
/// <summary>
///     AL1403: Code marked [AotSafe] must not call methods with [RequiresDynamicCode].
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1403AotSafeViolationAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1403.</summary>
    private const string DiagnosticId = "AL1403";
