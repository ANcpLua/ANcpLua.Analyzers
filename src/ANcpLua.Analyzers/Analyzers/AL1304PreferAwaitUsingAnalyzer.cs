...
/// <summary>
///     AL1304: Detects <c>using</c> statements on IAsyncDisposable types inside async methods.
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1304PreferAwaitUsingAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1304.</summary>
    private const string DiagnosticId = "AL1304";
