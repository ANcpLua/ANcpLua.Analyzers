...
public sealed partial class Al1407AvoidExpressionCompileAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1407.</summary>
    private const string DiagnosticId = "AL1407";
