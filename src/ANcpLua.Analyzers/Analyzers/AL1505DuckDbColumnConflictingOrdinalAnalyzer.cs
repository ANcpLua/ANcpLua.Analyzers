...
/// <summary>
///     AL1505: Detects multiple [DuckDbColumn] properties on the same type with duplicate Ordinal values.
/// </summary>
/// <remarks>
...
public sealed partial class Al1505DuckDbColumnConflictingOrdinalAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1505.</summary>
    private const string DiagnosticId = "AL1505";
