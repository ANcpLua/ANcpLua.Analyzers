...
/// <summary>
///     AL1001: Don't repeat negated patterns (not not not...).
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1001DontRepeatNegatedPatternAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1001.</summary>
    public const string DiagnosticId = "AL1001";
