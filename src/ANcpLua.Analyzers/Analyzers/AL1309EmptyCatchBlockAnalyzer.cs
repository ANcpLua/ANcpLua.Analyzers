...
/// <summary>
///     AL1309: Detects empty catch blocks that silently swallow exceptions.
/// </summary>
/// <remarks>
///     <para>
...
public sealed partial class Al1309EmptyCatchBlockAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1309.</summary>
    private const string DiagnosticId = "AL1309";
