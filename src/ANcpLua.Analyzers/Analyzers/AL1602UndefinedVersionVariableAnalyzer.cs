...
/// <summary>
///     AL1602: Detects undefined version variables in Directory.Packages.props files.
///     When $(VariableName) is used but not defined in Version.props, this analyzer flags it.
/// </summary>
/// <remarks>
///     <para>
///         This analyzer completes the version management trio (AL1600, AL1601, AL1602):
///         - AL1600: Detects hardcoded versions (should use $(Variable))
///         - AL1601: Detects missing Version.props import
///         - AL1602: Detects undefined variables ($(Variable) not in Version.props)
///     </para>
///     <para>
...
public sealed partial class Al1602UndefinedVersionVariableAnalyzer : DiagnosticAnalyzer {
    /// <summary>AL1602: Undefined version variable.</summary>
    private const string DiagnosticId = "AL1602";
    ...
    private static readonly LocalizableResourceString s_title = new(
        nameof(Resources.AL1602AnalyzerTitle), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_messageFormat = new(
        nameof(Resources.AL1602AnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));

    private static readonly LocalizableResourceString s_description = new(
        nameof(Resources.AL1602AnalyzerDescription), Resources.ResourceManager, typeof(Resources));
    ...
    private static void AnalyzePackagesPropsFile(
        ...
        try {
            ...
            foreach (var pkg in packageVersions) {
                ...
                if (!match.Success) {
                    continue; // Not a variable reference (AL1600 handles hardcoded versions)
                }
