...
/// <summary>
///     AL1314: Suggests using <c>Math.Round</c> / <c>MathF.Round</c> overloads with an explicit
...
public sealed partial class Al1314UseExplicitMidpointRoundingAnalyzer : AlAnalyzer {
    /// <summary>The diagnostic identifier for AL1314.</summary>
    public const string DiagnosticId = "AL1314";
